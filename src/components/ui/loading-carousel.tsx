...
export function LoadingCarousel({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto w-full max-w-3xl overflow-hidden rounded-xl bg-muted shadow-[0px_1px_1px_0px_rgba(0,0,0,0.05),0px_1px_1px_0px_rgba(255,252,240,0.5)_inset,0px_0px_0px_1px_hsla(0,0%,100%,0.1)_inset,0px_0px_1px_0px_rgba(28,27,26,0.5)]",
        className
      )}
    >
      <div className="w-full overflow-hidden rounded-xl">
        ...
        <div
          className={cn(
            "group bg-[#c9a84c] p-4 sm:p-5 text-background transition-colors",
        ...
        >
          ...
          >
            ...
            <div className="flex min-w-0 items-center gap-2 text-background">
              {backgroundTips ? (
                ...
                <div className="min-w-0 max-w-full">
                  {displayTips[current]?.url ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="wrap-break-word block max-w-full rounded-sm font-display italic text-2xl md:text-4xl leading-tight tracking-tight text-pretty focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-4 focus-visible:ring-offset-muted group-hover:text-foreground transition-colors"
                    >
                      {displayTips[current]?.text}
                    </a>
                  ) : (
                    <span className="wrap-break-word block max-w-full font-display italic text-2xl md:text-4xl leading-tight tracking-tight text-pretty group-hover:text-foreground transition-colors">
                      {displayTips[current]?.text}
                    </span>
                  )}
                  {displayTips[current]?.description && (
                    <p className="mt-2 text-sm md:text-base text-background/80 leading-relaxed group-hover:text-background transition-colors">
                      {displayTips[current]?.description}
                    </p>
                  )}
                </div>
