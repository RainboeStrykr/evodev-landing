  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-1 flex-col justify-center px-4 md:px-8">
        {/* Draggable Rail */}
        <motion.div
          className="relative mx-auto flex h-[340px] w-full max-w-6xl items-center justify-center cursor-grab active:cursor-grabbing"
          ...
          {visibleIndices.map((offset) => {
            ...
            return (
              <motion.div
                key={absIndex}
                className={cn(
                  "absolute h-[300px] md:h-[320px] rounded-2xl border-t border-white/20 bg-neutral-900 shadow-2xl transition-shadow duration-300 overflow-hidden",
                  isCenter ? "z-20 shadow-white/10" : "z-10",
                )}
                style={{ transformStyle: "preserve-3d", width: "auto" }}
                initial={false}
                animate={{
                  x: xOffset,
                  z: zOffset,
              ...
              >
                <img
                  src={item.imageSrc}
                  alt={item.title}
                  className="h-full w-auto max-w-[480px] rounded-2xl object-contain pointer-events-none"
                />
          ...
          <div className="flex flex-1 flex-col items-center text-center md:items-start md:text-left h-32 justify-center">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <h3 className="text-3xl font-bold tracking-tight md:text-4xl text-white">
                  {activeItem.title}
                </h3>
